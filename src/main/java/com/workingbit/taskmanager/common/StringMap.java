package com.workingbit.taskmanager.common;
...
public class StringMap extends AbstractMap<String, Object> {
    ...
    public static class StringMapBuilder {
        ...
        private static StringMapBuilder INSTANCE = new StringMapBuilder();
        private StringMap stringMap = new StringMap();

        public StringMapBuilder put(String key, Object value) {
            stringMap.put(key, value);
            return INSTANCE;
        }

        public static StringMapBuilder getInstance() {
            return INSTANCE;
        }
